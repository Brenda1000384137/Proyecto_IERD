                    ...
                    <div  class="card"  style="width: 30rem;" >
                      <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush" align="left">
                          ...
                          <li class="list-group-item"><strong> Rol: Coordinador  </strong></li>
                          <li  class="list-group-item"><a class="btn btn-primary btn-sm" href="editar_perfil.php?Usuario=<?php echo $_SESSION['id_usuario'] ?>"> Editar<i class="fa fa-pencil"></i>   
