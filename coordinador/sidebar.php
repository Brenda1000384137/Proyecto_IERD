...
<body>
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            ...
            <a href="../../coordinador.php"><img class="main-logo" src="../../img/logo/opcion.jpeg" alt="" width="130" heigth="130" /></a>
                <strong><a href="../../coordinador.php"><img src="../../img/logo/logo1.jpeg" width="40" height="40" /></a></strong>
            </div>
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="../perfil/perfilcoordinador.php" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    
                                                        <span class="admin-name"><?php echo $row['nombre']?> <?php echo $row['apellido']?></span>
                                                        <i class="fa fa-angle-down edu-icon edu-down-arrow"></i>
                                                    </a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                    <li><a ><span class="edu-icon edu-user-rounded author-log-ic"></span>Rol Coordinador</a>
                                                        </li>
                                                        <li><a href="../perfil/perfilcoordinador.php"><span class="edu-icon edu-user-rounded author-log-ic"></span>Perfil</a>
                                                        </li>
                                                        <li><a href="../../Vistas/logout.php"><span class="edu-icon edu-locked author-log-ic"></span>Cerrar Sesión</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
