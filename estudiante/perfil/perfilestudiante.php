            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="breadcome-menu">
                  <li><a href="estudiante.php">Inicio</a> <span class="bread-slash">/</span>
                  </li>
                    ...
                    <div  class="card"  style="width: 30rem;" >
                      <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush" align="left">
                          ...
                          <li class="list-group-item"><strong> Rol: Estudiante  </strong></li>
                          ...
                          <a class="btn btn-success btn-sm" href="cambiar_contra.php"> <i class="fa fa-pencil"></i> Cambiar contraseña</a>     </li>                        </ul> 
                    </div>
                  </div>
